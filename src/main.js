...
function createFloor() {
    ...
    const tileTexture = textureLoader.load(`${baseUrl}/textures/tileTexture.jpg`); 
...
function addTable() {
  ...
  loader.load(`${baseUrl}/models/Table.glb`, (gltf) => {
...
function addCake() {
  const loader = new GLTFLoader();
  loader.load(`${baseUrl}/models/cakeBirthday.glb`, (gltf) => {
